...
function loadApprovalAlert(): { orderNo: string; reason: string; purchaseId?: number } | null {
  try {
...
export const approvalAlert = ref<{ orderNo: string; reason: string; purchaseId?: number } | null>(loadApprovalAlert())

export function setApprovalAlert(orderNo: string, reason: string, purchaseId?: number) {
  const v = { orderNo, reason, purchaseId }
