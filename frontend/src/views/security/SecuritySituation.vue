...
const disclaimer = ref('地图位置由真实事件 IP 稳定映射推导，仅用于态势可视化。')
  ...
  <div class="situation-page">
    <header class="situation-header">
      ...
      <div class="header-center">
        ...
        <div class="title-deco">
          <div class="line" />
          <p class="subtitle">CAMPUS SUPPLY CHAIN SECURITY SITUATION</p>
          <div class="line" />
        </div>
    ...
    <main class="situation-main">
          ...
          <div class="map-overlay">
            <div class="overlay-card">
              ...
              <div class="overlay-body">
                ...
                <p class="map-note">所有地图攻击线均由真实事件 IP 做稳定映射推导，不代表精确 Geo-IP 情报。</p>
              </div>
            </div>
          </div>
          <div class="corner-tl" />
      ...
      <aside class="attack-sidebar">
        ...
        <div v-else class="attack-empty">
          当前没有可展示的真实事件，页面保持为空态而不再生成随机攻击动画。
        </div>
      </aside>
    </main>
