...
.overview-screen {
  ...
  background: radial-gradient(
    circle at 50% -20%,
    var(--screen-bg-mid) 0%,
    var(--screen-bg-bottom) 52%,
    var(--screen-bg-top) 100%
  );
}
...
.risk-metric {
  ...
  &.danger { background: rgba(127, 29, 29, 0.38); }
  &.warning { background: rgba(113, 63, 18, 0.38); }
  &.info { background: rgba(12, 74, 110, 0.38); }
}
...
.tag {
  ...
  &.high { background: rgba(220, 38, 38, 0.3); color: #fecaca; }
  &.medium { background: rgba(234, 179, 8, 0.26); color: #fde68a; }
  &.low { background: rgba(59, 130, 246, 0.25); color: #bfdbfe; }
}
